    ...
    return (
        <section className="py-60 px-6 text-center bg-[#f7f7f5]">
            <div className="max-w-4xl mx-auto">
                ...
                <h2 className="font-quote-header text-3xl md:text-5xl uppercase leading-tight tracking-tight text-black">
                ...
                <p className="mt-8 text-[10px] uppercase tracking-[0.4em] font-bold text-black font-quote-body">Standard of Qdla</p>
            </div>
        </section>
    );
};
