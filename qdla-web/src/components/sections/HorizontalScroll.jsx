                    ...
                    {cards.map((card, i) => {
                        ...
                        return (
                            <CardWrapper 
                                key={i}
                                {...wrapperProps}
                                className="block relative h-[50vh] md:h-[60vh] w-[85vw] md:w-[40vw] shrink-0 overflow-hidden rounded-[1.5rem] md:rounded-[2rem] bg-neutral-900 group cursor-pointer border border-white/5 hover:border-white/20 transition-colors"
